...
def group_assignment(driver, group_formed, asmt_list_url):
	...
	if group_formed == educator_formed:
		...
		finalize_date.click()
		ok_btn1 = driver.find_elements_by_css_selector("button.md-ink--primary")[1]
		ok_btn1.click()
		finalize_time = driver.find_element_by_id("finalize-group-date-timepicker")
		ok_btn2 = driver.find_elements_by_css_selector("button.md-ink--primary")[1]
		ok_btn2.click()
	...
	aprbs = driver.find_element_by_css_selector("[role='checkbox'].md-fake-btn .md-text--inherit")[0]
	aprbs.click()
